...
Foreach ($item in $ProfileList) {
	...
	$acctrusloc = Test-Path -Path registry::HKEY_USERS\$($Item.SID)\Software\Policies\Microsoft\Office\16.0\Access\Security\'Trusted Locations'
	...
	$extrusloc = Test-Path -Path registry::HKEY_USERS\$($Item.SID)\Software\Policies\Microsoft\Office\16.0\Excel\Security\'Trusted Locations'
	...
	$pwrptrusloc = Test-Path -Path registry::HKEY_USERS\$($Item.SID)\Software\Policies\Microsoft\Office\16.0\Powerpoint\Security\'Trusted Locations'
	...
	$prjttrusloc = Test-Path -Path registry::HKEY_USERS\$($Item.SID)\Software\Policies\Microsoft\Office\16.0\'MS Project'\Security\'Trusted Locations'
	...
	$vistrusloc = Test-Path -Path registry::HKEY_USERS\$($Item.SID)\Software\Policies\Microsoft\Office\16.0\Visio\Security\'Trusted Locations'
	...
	$wordtrusloc = Test-Path -Path registry::HKEY_USERS\$($Item.SID)\Software\Policies\Microsoft\Office\16.0\Word\Security\'Trusted Locations'
